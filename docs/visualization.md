...
This guide explains how to visualize `peclet.dem` simulation results using **Ovito** (for particles) and **ParaView** (for fields).

---

# Part 1: Particle Visualization (Ovito)

This section explains how to visualize `peclet.dem` simulation results using Ovito.

## 1. Prerequisites

- **Ovito Pro** or **Ovito Basic** (free).
- Generated `particle_shape.stl` (run `python examples/generate_particles.py`).
