"""Reusable dense-random-packing protocol for the DEM engine (the measured successor of
verify_packing_spheres.py, whose phi is the design value by construction).
