...
def test_sdf_sphere_binary_restitution():
    """An SDF-built sphere reproduces the analytic-sphere restitution within shell tolerance."""
    for e in (0.3, 0.8):
...
def test_cube_stick_slip():
    """Cubes on a tan(theta)=0.5 incline with free rotation: stick at mu=0.9, slide at mu=0.05."""
