...
def test_kinetic_slide():
    """Rotation locked, gx=8, gz=10: a = 8 - 10 mu."""
...
def test_oblique_impact_walton():
    """Walton (e, mu, beta) closed forms for an oblique no-spin impact on a frictional floor."""
...
def test_binary_restitution_with_friction():
    """The cone must not touch head-on impacts."""
    for e in (0.2, 0.8):
        ee = binary_e(e)
